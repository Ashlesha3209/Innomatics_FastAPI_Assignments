...
# Task 1: Initial products + 3 new items
products = [
    ...
    {"id": 4, "name": "Gaming Headset", "price": 3499, "category": "Electronics", "in_stock": True},
    # Added items
...
def get_deals():
    if not products: return {"message": "No products available"}
